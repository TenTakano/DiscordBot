...
Application.put_env(:discord_bot, DiscordBot.Discord.Random,
  module: DiscordBot.Discord.Random.Mock
)
...
Application.put_env(:discord_bot, DiscordBot.Infra.HttpClient,
  module: DiscordBot.Infra.HttpClient.Mock
)
